...
public class Thrower extends Unit {
    ...
    public Thrower(int hp, String name, int damage, int run,int accuracy) {
    ...
    public static Unit create() {
        ...
        Weapon weaponForThrower = new Weapon("Метательное копье", random2,random2,random3);
        ...
        Thrower thrower = new Thrower(random2, "Метатель", random2, random2,random2);
